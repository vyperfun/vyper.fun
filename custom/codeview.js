...
window.$docsify.plugins.push(function (hook, vm) {
  ...
  hook.afterEach(function (html) {
    ...
    var template_element = htmlDoc.getElementsByClassName(
      'lang-embed-template'
    )[0];
    var final_element = htmlDoc.getElementsByClassName('lang-embed-final')[0];
    var previous_element = htmlDoc.getElementsByClassName(
      'lang-embed-previous'
    )[0];
    ...
    if (template_element || final_element) {
      ...
      var one_col = ['<div class="fullpage">', html, '</div>'].join('');
    ...
    if (document.getElementById('editor')) {
      ...
      if (window.code_previous && window.code_template) {
        ...
        previous_button.onclick = function () {
          ...
          let selected_elements = document.getElementsByClassName(
          ...
          document
            .getElementById('editor-previous-button')
            .classList.add('editor-button-selected');
        };
      ...
      if (window.code_template) {
        ...
        template_button.onclick = function () {
          ...
          document
            .getElementById('editor-template-button')
            .classList.add('editor-button-selected');
        };
      ...
      if (window.code_final) {
        ...
        final_button.onclick = function () {
          ...
          document
            .getElementById('editor-final-button')
            .classList.add('editor-button-selected');
        };
      ...
      if (window.code_template && window.code_final) {
        ...
        diff_button.onclick = function () {
          ...
          document
            .getElementById('editor-diff-button')
            .classList.add('editor-button-selected');
        };
...
function loadDiffEditor(original_text, modified_text) {
  require(['vs/editor/editor.main'], function () {
    ...
    window.monaco_editor = monaco.editor.createDiffEditor(
      document.getElementById('editor'),
      {
        language: 'python',
        theme: 'vs-dark',
    ...
    var originalModel = monaco.editor.createModel(original_text, 'python');
    var modifiedModel = monaco.editor.createModel(modified_text, 'python');
